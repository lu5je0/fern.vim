...
execute join(['function! vital#_fern#App#Args#import() abort', printf("return map({'set': '', 'pop': '', 'get': '', 'throw_if_dirty': ''}, \"vital#_fern#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
